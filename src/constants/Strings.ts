...
The Platform and the Service is administered and maintained by Eggnation and Applicnation. The terms "we", "us" and "our" refer collectively to Eggnation and Applicnation. The term "you" refers to the person visiting, viewing or using the Platform.
      
Please read these Terms carefully. They contain important information regarding your legal rights, including limitations on Eggnation’s and certain third parties' liability, disclaimers of warranties and a submission to jurisdiction. Each time you access the Service by any means (for example, through the Internet or on a mobile device), you irrevocably agree to comply with the version of the Terms posted on the Platform at the time you access the Platform. You may not use the Platform or the Service if you do not agree to these Terms.`;

export const S_TS_ELIGIBILITY_TITLE = 'Eligibility';
export const S_TS_ELIGIBILITY_CONTENT = `In order to access or use our Service, you must be at least 13 years of age. If you are younger than 13 and register an account with us, your account will be eligible for termination, and all prizes won by the terminated account will be revoked.`;
...
export const S_TS_LICENSE_TITLE = 'License';
export const S_TS_LICENSE_CONTENT = `You must only use the Service as expressly permitted by these Terms. All rights not expressly granted to you are reserved by Eggnation, its third-party providers and other respective owners, if any.

The Platform contains intellectual property that you may not use for commercial purposes unless permission is expressly granted to you by us. This intellectual property includes, but is not limited to artwork, animations or any trademarks that belong to us.`;

export const S_TS_PROHIBITED_ACTIVITIES_TITLE = 'Prohibited Activities';
export const S_TS_PROHIBITED_ACTIVITIES_CONTENT = `You agree that you will not (a) Violate, bypass or circumvent any security measure intended to limit or prevent access to the Platform, Content or Service. (b) Make use of any of our trademarks, service marks, trade names or logos or those of any third party displayed on the Platform;

Additionally, you acknowledge and agree that you (and not Eggnation and Applicnation) are solely responsible for obtaining and maintaining all telecommunications, broadband, and computer hardware, equipment, software and services needed for you to access and use the Service, and paying all charges related thereto.`;

export const S_TS_FEEDBACK_TITLE = 'Feedback';
export const S_TS_FEEDBACK_CONTENT = `All questions, concerns, suggestions and feedback will be treated as non-confidential and non proprietary. Eggnation will be free to use any ideas, concepts or techniques contained within the question, concern, suggestion or feedback without any attribution or compensation to you.`;
